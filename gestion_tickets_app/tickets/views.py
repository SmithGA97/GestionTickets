...
class TicketListCreateAPIViewset(mixins.ListModelMixin, mixins.CreateModelMixin,
    ...
    def get_queryset(self):
        ...
        if start_date and end_date:
            ...
            if start_date_p and end_date_p:
                ...
                raise serializers.ValidationError("""Invalid datetime format provided: start_date
                                                and end_date  must be something like 
                                                  YYYY-MM-DDTHH:MM:SS, ex: 2024-05-05T15:35:00""")
        ...
        if status and status in ('NOT_STARTED', 'IN_PROCESS', 'COMPLETED'):
            ...
            raise serializers.ValidationError("""Status must be 'NOT_STARTED,
                                              IN_PROCESS, or COMPLETED""")
        return queryset
