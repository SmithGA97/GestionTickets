...
class Ticket(models.Model):
    ...
    creation_date = models.DateTimeField(
        auto_now_add=True, verbose_name="creation date", editable=False
    )
    number_of_images = models.IntegerField(verbose_name="number of images")
    uploaded_images = models.IntegerField(
        verbose_name="number of uploaded images", default=0
    )
    status = models.CharField(choices=Status.choices, default=Status.NOT_STARTED)
